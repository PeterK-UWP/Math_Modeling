...
"""
This code has been taken from my previous work in High energy analysis
Test with a data file and use the __main__ to re-learn the file
you need a .txt or .data file
"""
